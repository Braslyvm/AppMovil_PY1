...
import cambioscreens from './TipoCambio';
import ConversorScreen from './Conversor';
...
export default function MainApp() {
  ...
  return (
    ...
    >
      ...
      />
      <Drawer.Screen
        name={translatedContent.convertir}
        component={ConversorScreen}
        options={{
          drawerLabel: translatedContent.convertir,
      ...
      />
      <Drawer.Screen
        name={translatedContent.tipoCambio}
        component={cambioscreens}
        options={{
          drawerLabel: translatedContent.tipoCambio,
          headerStyle: { backgroundColor: dark ? '#121212' : '#E5D9F2' },
          headerTintColor: dark ? '#E5E5E5' : '#000',
          headerTitleStyle: { fontWeight: 'bold' },
        }}
